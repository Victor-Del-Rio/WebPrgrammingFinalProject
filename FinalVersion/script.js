...
var all_questions = [{
    ...
    question_string: "What is 1+2?",
    choices: {
        correct: "3",
        wrong: ["2", "1", "4"]
    }
}, {
    question_string: 'What is 4-0?',
    choices: {
        correct: "4",
        wrong: ["2", "3", "1"]
    }
    ...
    $('#submit-button').click(function() {
        ...
        for (var i = 0; i < self.questions.length; i++) {
            ...
            $('#quiz-retry-button').click(function() {
                window.location.href = "http://localhost/WPFinal/CSCILab.php";
            });
...
$(document).ready(function() {
    ...
    var quiz = new Quiz('CSCI Lab Page');
